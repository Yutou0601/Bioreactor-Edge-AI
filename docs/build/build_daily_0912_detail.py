...
![圖 1](fig_daily_0912/fig1_泵節奏三批對照.png)

*圖 1　循環泵的節奏。三批的泵窗位置不同（第 50、25、13 分），但長度分別是 1、5、10 分鐘，與各批宣稱的 τ 完全一致。陰影為泵運轉區間。*
...
![圖 3](fig_daily_0912/fig3_循環一致性與內部剖面.png)

*圖 3　左：13 個自動循環疊合，形狀高度一致。右：循環內相對速率高低交替，含泵窗的半小時速率高——下降並非等速。*
...
![圖 4](fig_daily_0912/fig4_估計量比較.png)

*圖 4　同一段資料、四種估計量的差異。衰退期皆為負值，代表該期間沒有甲烷在產生。*
...
![圖 2](fig_daily_0912/fig2_tau槓桿.png)

*圖 2　左：實測泵窗長度與宣稱的 τ 完全落在 y = x 上。右：下降速率隨 τ 單調上升。*
