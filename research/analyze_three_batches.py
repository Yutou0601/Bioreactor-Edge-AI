...
rcParams.update({
    # JhengHei carries the CJK glyphs but lacks U+2212 MINUS SIGN and U+2264/U+2265,
    # which render as tofu boxes in labels. matplotlib >= 3.6 falls back per glyph
    # when font.family is a list, so DejaVu Sans (bundled) covers the gaps.
    'font.family': ['Microsoft JhengHei', 'DejaVu Sans'], 'axes.unicode_minus': False,
